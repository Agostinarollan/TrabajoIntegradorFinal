...
namespace TrabajoPractico_Integrador.Controllers
{
    public class DireccionesController : Controller
    {
        ...
        {
            ViewData["ClienteID"] = new SelectList(_context.Clientes, "Id", "Nombre","direcion.ClienteID");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Calle,Numero,Ciudad,CodigoPostal,ClienteID")] Direccion direccion)
        {
            if (id != direccion.Id)
            {
                return NotFound();
