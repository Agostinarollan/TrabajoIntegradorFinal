...
namespace TrabajoPractico_Integrador.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,Stock,PrecioVenta")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Stock,PrecioVenta")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
